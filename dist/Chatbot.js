              ...
              case 0:
                return _context.abrupt('return', new Promise(function (resolve) {
                  _googleOauthJwt2.default.authenticate({
                    email: _this2.props.googleClientEmail,
                    key: _this2.props.googlePrivateKey,
        ...
        return _regenerator2.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 5:
                _context4.next = 7;
                return fetch('https://dialogflow.googleapis.com/v2/projects/' + this.props.googleProjectId + '/agent/sessions/' + this.props.dialogFlowSessionId + _jsCookie2.default.get('userID') + ':detectIntent', {
                  method: 'POST',
                  headers: {
    ...
    value: function renderMessages(stateMessages) {
      ...
      if (stateMessages) {
        return stateMessages.map(function (message, i) {
          return _this3.renderOneMessage(message, i);
        });
      }
      return null;
    }
